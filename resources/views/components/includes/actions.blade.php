<div {{ $attributes
            ...
            ->class([
                'flex flex-cols py-2 space-x-2' => ($this->isTailwind || $this->isDaisyUI) && ($this->getActionWrapperAttributes['default-styling'] ?? true),
                '' => ($this->isTailwind || $this->isDaisyUI) && ($this->getActionWrapperAttributes['default-colors'] ?? true),
