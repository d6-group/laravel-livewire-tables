<div {{ $attributes
            ...
            ->class(['flex flex-cols justify-center' => ($this->isTailwind || $this->isDaisyUI) && $this->getActionWrapperAttributes()['default-styling'] ?? true])
            ->class(['' => ($this->isTailwind || $this->isDaisyUI) && $this->getActionWrapperAttributes()['default-colors'] ?? true])
