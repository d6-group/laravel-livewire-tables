...
<tr
    ...
    {{
        $attributes->merge($customAttributes)
                ...
                ->class(['bg-base-100 rappasoft-striped-row' => ($component->isDaisyUI() && ($customAttributes['default'] ?? true) && $rowIndex % 2 === 0)])
                ->class(['bg-base-content/5 rappasoft-striped-row' => ($component->isDaisyUI() && ($customAttributes['default'] ?? true) && $rowIndex % 2 !== 0)])
