...
<tr
    ...
    {{
        $attributes->merge($customAttributes)
                ...
                ->class(['bg-white dark:bg-gray-700 dark:text-white rappasoft-striped-row' => ($component->isDaisyUI() && ($customAttributes['default'] ?? true) && $rowIndex % 2 === 0)])
                ->class(['bg-gray-50 dark:bg-gray-800 dark:text-white rappasoft-striped-row' => ($component->isDaisyUI() && ($customAttributes['default'] ?? true) && $rowIndex % 2 !== 0)])
                ->class(['cursor-pointer' => ($component->isDaisyUI() && $component->hasTableRowUrl() && ($customAttributes['default'] ?? true))])
