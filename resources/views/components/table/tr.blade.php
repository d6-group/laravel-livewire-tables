...
<tr
    ...
    {{
        $attributes->merge($customAttributes)
                ...
                ->class(['cursor-pointer' => (($isTailwind || $isDaisyUI) && $this->hasTableRowUrl() && ($customAttributes['default'] ?? true))])
                ->class(['bg-base-100 rappasoft-striped-row' => ($isDaisyUI && ($customAttributes['default'] ?? true) && $rowIndex % 2 === 0)])
                ->class(['bg-base-content/5 rappasoft-striped-row' => ($isDaisyUI && ($customAttributes['default'] ?? true) && $rowIndex % 2 !== 0)])
