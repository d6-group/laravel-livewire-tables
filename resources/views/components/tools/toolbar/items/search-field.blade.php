...
<div 
    @class([
        ...
        'flex rounded-md shadow-sm' => $this->isDaisyUI,
    ])>
        <input
            ...
            {{ 
                ...
                ->class([
                    ...
                    'w-full input input-sm' => $this->isDaisyUI && $this->hasSearch() && $this->getSearchFieldAttributes()['default'] ?? true,
        ...
        <div @class([
                ...
                <div
                    ...
                    @class([
                            ...
                            'inline-flex h-full items-center px-3 text-gray-500 bg-gray-50 rounded-r-md border border-l-0 border-gray-300 cursor-pointer sm:text-sm dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600' => $this->isDaisyUI,
                        ])
                >
                @if($this->isTailwind)
