    ...
    <select wire:model.live="perPage" id="{{ $tableName }}-perPage"
        {{ 
            ...
            ->class([
                ...
                'w-full select select-sm select-bordered text-base-content' => $this->isDaisyUI && $component->getPerPageFieldAttributes()['default-styling'],
                'w-full select select-sm select-bordered text-base-content' => $this->isDaisyUI && $component->getPerPageFieldAttributes()['default-colors'],
            ])
