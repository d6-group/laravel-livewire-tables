    ...
    <select wire:model.live="perPage" id="{{ $tableName }}-perPage"
        {{ 
            ...
            ->class([
                ...
                'w-full select select-sm select-bordered text-base-content' => $this->isDaisyUI && $this->getPerPageFieldAttributes()['default-styling'],
                '' => $this->isDaisyUI && $this->getPerPageFieldAttributes()['default-colors'],
            ])
