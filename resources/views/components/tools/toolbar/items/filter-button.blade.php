...
>
    <div
        ...
        @class([
            ...
            'relative block md:inline-block text-left' => $component->isTailwind() || $component->isDaisyUI(),
        ])
    >
        <div>
            <button
            ...
            >
                ...
                @if ($count = $component->getFilterBadgeCount())
                    <span @class([
                            'badge badge-neutral' => $component->isBootstrap(),
                            ...
                            'ml-1 badge' => $component->isDaisyUI(),
                        ])>
                        {{ $count }}
                    </span>
                @endif
